...
Сервер создан для хранения карточек с картинками а так же взаимодействия с ними (лайк, дизлайк, удаление). Также данный сервер имеет возможность создать пользователя и хранить инфомрацию в базе данных: почту, имя, описание пользователя, пароль.
